...
was not necessary since all the objects were pre-aligned already. The Procrustes transformation is closely related to the
...
Similarly to the angle based method presented in Section \ref{subsub:windowbyangle}, this leads to the spline parameters $[t_{rho}-\Delta t_i, t_{rho}+\Delta t_i]$ of the last iteration $i$, inbetween which the window at angle $\rho$ of length $l$ is defined.
