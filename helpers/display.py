...
def comparison(bones, compare_fn, window_extractors, feature_extractors):
    window = windows.ComparisonWindow(bones, compare_fn, window_extractors, feature_extractors)
    show_window(window)
    return window
